...
\end{parts}
    ...
    \begin{parts}
        ...
        \]
        if and only there are $a,b>0$ such that $-\vu = a\vv + b\vw$.
...
(If your decision boundary looks strange, note the relative sizes of the two classes.)
...
(If it's too much trouble to get the equation of the decision boundary from whatever implementation of Gaussian na\"ive Bayes you're using, don't worry about it.)
...
\part Test your four models on their corresponding testing sets: For each test observation, $x$,
